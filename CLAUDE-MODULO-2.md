...
- ⬜ Fases 3–9: pendientes. Pendiente puntual de Fase 2 para la Fase 6: sala de Socket.io por sucursal para que `turno:desbloqueado` llegue al POS del cajero (hoy solo se emite a la sala de admins).
