...
import { listarProductos, crearProducto, actualizarProducto, historialPrecios, cambiarPrecio } from '../../api/productos';
...
type Tab = 'productos' | 'precios' | 'proveedores' | 'sucursales';
